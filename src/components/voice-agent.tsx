...
export default function VoiceAgent({ isDarkMode }: VoiceAgentProps) {
  return (
    <div
      className={`w-full max-w-md mx-auto p-6 rounded-2xl shadow-2xl border backdrop-blur-sm transition-all duration-300 ${
    ...
    >
      ...
      <iframe
        ...
        className={`w-full h-[500px] border-0 rounded-xl shadow-inner transition-colors duration-300 ${
